export default {
  ...
  referral: {
    title: '邀请好友',
    subtitle: '邀请好友注册，双方获得奖励',
    inviteCodeManagement: '邀请码管理',
    inviteDetails: '邀请明细',
    registeredUserCount: '已注册用户数',
    perInviteRewardTraffic: '每次邀请可获得流量',
    totalRewardTraffic: '已获得总流量',
    createdAt: '创建时间',
    actions: '操作',
    ...
    howItWorks: '如何运作',
    step1: '1. 分享您的邀请链接或邀请码',
    step2: '2. 好友通过您的链接注册',
    step3: '3. 好友下单后您获得佣金奖励',
    commissionNote: '佣金将在订单确认后计入您的账户',
  },
  checkout: {
    title: '结算',
    subtitle: '完成您的购买',
