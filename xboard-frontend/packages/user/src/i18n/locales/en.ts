export default {
  ...
  referral: {
    ...
    perInviteRewardTraffic: 'Reward per Invite',
    totalRewardTraffic: 'Total Reward',
    ...
    generateSuccess: 'Invite code generated',
    generateFailed: 'Failed to generate invite code',
    noReferrals: 'No referrals',
    noCommissions: 'No commission logs',
    ...
    step1: '1. Share your referral link or invite code',
    step2: '2. Friends register via your link',
    step3: '3. Earn rewards after they purchase',
    commissionNote: 'Rewards will be credited after confirmation',
  },
  checkout: {
    title: 'Checkout',
